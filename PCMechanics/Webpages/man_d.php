...
/*      ----------------------------------------------------------------------------------------------------------           */
             .subTag
            {
                width: 400px; height: 50px;font-family: windowsDefault; font-size: 40px; line-height: 50px;
    ...
    <body id="spider">
        ...
        <div id="inpageTitle">
            <div id="titleImage"><img src="../Images/UI/menuItems/whddIcon.png" width="80%" height="100%" style="margin-left : 5px;"/></div>
            <div id="currentPageIndicator"><strong>Storage Device</strong></div>
        </div>
    ...
    <!--   -------------------------------------------------------------------------------     -->    
        ...
        <div id="pentiumTitle" class="subTag" style="margin-top:50px;">Mechanical Drives</div>
        <div id="contentWindow1" class="contentWindow" onclick="specsheet_called(1);"><img src="../Images/Hdd/hdd.jpeg" width="100%" height="100%"/></div>
        <div id="contentWindow2" class="contentWindow" onclick="specsheet_called(2);"><img src="../Images/Hdd/hdd.jpeg" width="100%" height="100%"/></div>
        
        <div id="nameTag1" class="nameTag">Seagate barracuda</div>
        <div id="nameTag2" class="nameTag">Seagate barracuda</div>
        ...
        <div id="i3Title" class="subTag">Solid State Drives</div>
        
        
        
        <div id="contentWindow3" class="contentWindow" onclick="specsheet_called(3);"><img src="../Images/Hdd/ssd.jpeg" width="100%" height="100%"/></div>
        <div id="contentWindow4" class="contentWindow" onclick="specsheet_called(4);"><img src="../Images/Hdd/ssd.jpeg" width="100%" height="100%"/></div>
        
        <div id="nameTag3" class="nameTag">Samsung Evo</div>
        <div id="nameTag4" class="nameTag">Samsung Evo</div>
                ...
                if(prev_button==buy_button)   //After Reclicking Selected Icon
                   {
                    ...
                    $("#proceed").click(function(){
                            ...
                            if(buy_button==2)
                                buy_button=3;
                            else if(buy_button==3)
                                buy_button=2;
               
                            window.location="man_g.php?pro="+buy_button;
...
//        ---------------------------------------------------------------------------
            ...
            function specsheet_called(specsheet)
            {
                $("#specsheet").css("display","block");
                    $("#valuec").empty();
                    var name, cores,  price, ff, capa, cache;
                    generation = "6th";
                    if (specsheet==1)
                        {
                    ...
                    $("#valuec").append("<br/>").append(": ").append(ff);
                    $("#valuec").append("<br/>").append(": ").append(cache);
                    $("#valuec").append("<br/>").append(": ").append(capa);
