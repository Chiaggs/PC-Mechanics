<html>
    ...
    <head>
        ...
        <style>
            ...
            #component3, #component4, #component6
            {
...
/*      ----------------------------------------------------------------------------------------------------------           */
            ...
            #contentWindow1,  #contentWindow3, #contentWindow8
            {
                clear: left;
            }
            .nameTag
    ...
    <body id="spider">
       ...
       <div id="specsheet">
        ...
        <div id="inpageTitle">
            <div id="titleImage"><img src="../Images/UI/menuItems/wgfxCardIcon.png" width="100%" height="100%"/></div>
            <div id="currentPageIndicator"><strong>Graphic Card</strong></div>
        </div>
        ...
        <div id="skip">I'll skip this</div>
    ...
    <!--   -------------------------------------------------------------------------------     -->    
        ...
        <div id="pentiumTitle" class="subTag" style="margin-top:50px;">700 Series</div>
        <div id="contentWindow1" class="contentWindow" onclick="specsheet_called(1);"><img src="../Images/Graphic Card/gt_710.jpg" width="100%" height="100%"/></div>
        <div id="contentWindow2" class="contentWindow" onclick="specsheet_called(2);"><img src="../Images/Graphic Card/gt_730.jpg" width="100%" height="100%"/></div>
        
        <div id="nameTag1" class="nameTag">GT 710</div>
        <div id="nameTag2" class="nameTag">GT 730</div>
        ...
        <div id="i3Title" class="subTag">1000 Series</div>
        
        <div id="contentWindow3" class="contentWindow" onclick="specsheet_called(3);"><img src="../Images/Graphic Card/gtx_1060.jpg" width="100%" height="100%"/></div>
        <div id="contentWindow4" class="contentWindow" onclick="specsheet_called(4);"><img src="../Images/Graphic Card/gtx_1070.jpg" width="100%" height="100%"/></div>
        <div id="contentWindow5" class="contentWindow" onclick="specsheet_called(5);"><img src="../Images/Graphic Card/gtx_1080.jpg" width="100%" height="100%"/></div>
        <div id="nameTag3" class="nameTag">GTX 1060</div>
        <div id="nameTag4" class="nameTag">GTX 1070</div>
        <div id="nameTag5" class="nameTag">GTX 1080</div>
    ...
    // ----------------------------------------------------------------------------------------
                ...
                if(prev_button==buy_button)   //After Reclicking Selected Icon
                   {
                    ...
                    $("#proceed").click(function(){
                            ...
                            window.location="manual.php?pro="+buy_button;
            ...
            $("#skip").click(function(){
                            ...
                            window.location="manual.php?pro=0";
...
//        ---------------------------------------------------------------------------
            ...
            function specsheet_called(specsheet)
            {
                $("#specsheet").css("display","block");
                    $("#valuec").empty();
                    var name, clockspeed, cores, threads,  price, cuda;
                    generation = "6th";
                    if (specsheet==1)
                        {
                            name = "Nvidia GT 710";
                            cores = "2GB DDR3 64 Bit";
                            threads = "954 MHz";
                            clockspeed = "2.0";
                            cuda = "192 CUDA Cores";
                            price = "Rs. 3,100"; 
                    ...
                    else if (specsheet==3)
                        {
                            ...
                            cores = "3GB DDR5 192 Bit";
                            threads = "1506 MHz";
                            clockspeed = "3.0";
                            cuda = "1152 CUDA Cores";
                            price = "Rs. 24,000"; 
                    ...
                    else if (specsheet==4)
                        {
                            ...
                            cores = "8GB DDR5 256 Bit";
                            threads = "1506 MHz";
                            clockspeed = "3.0";
                            cuda = "1920 CUDA Cores";
                            price = "Rs. 40,000"; 
                    ...
                    $("#valuec").append("<br/>").append(": ").append(cuda);
