<html>
    ...
    <head>
        ...
        <style>
            ...
            #footer
            {
                width: 100%; height: 250px; position: absolute; margin-top: 1900px; background: #001013;
            }
...
/*      ----------------------------------------------------------------------------------------------------------           */
    ...
    <!--   -------------------------------------------------------------------------------     -->    
        ...
        <div id="contentWindow1" class="contentWindow" onclick="specsheet_called(1);"><img src="../Images/Processors/Pentium_G4400.jpg" width="100%" height="100%"/></div>
        ...
        <div id="contentWindow2" class="contentWindow" onclick="specsheet_called(2);"><img src="../Images/Processors/i3_common.jpg" width="100%" height="100%"/></div>
        <div id="contentWindow3" class="contentWindow" onclick="specsheet_called(3);"><img src="../Images/Processors/i3_common.jpg" width="100%" height="100%"/></div>
        <div id="contentWindow4" class="contentWindow" onclick="specsheet_called(4);"><img src="../Images/Processors/i3_common.jpg" width="100%" height="100%"/></div>
        ...
        <div id="contentWindow5" class="contentWindow" onclick="specsheet_called(5);"><img src="../Images/Processors/i5_6400.jpg" width="100%" height="100%"/></div>
        <div id="contentWindow6" class="contentWindow" onclick="specsheet_called(6);"><img src="../Images/Processors/i5_6500.jpg" width="100%" height="100%"/></div>
        <div id="contentWindow7" class="contentWindow" onclick="specsheet_called(7);"><img src="../Images/Processors/i5_6600.jpg" width="100%" height="100%"/></div>
        ...
        <div id="contentWindow8" class="contentWindow" onclick="specsheet_called(8);"><img src="../Images/Processors/i7_6700K.jpg" width="100%" height="100%"/></div>
                ...
                if(prev_button==buy_button)   //After Reclicking Selected Icon
                   {
                    ...
                    $("#proceed").click(function(){
                            ...
                            window.location="man_m.php?pro="+buy_button;
...
//        ---------------------------------------------------------------------------
            ...
            function specsheet_called(specsheet)
            {
                $("#specsheet").css("display","block");
                    $("#valuec").empty();
                    var name, clockspeed, power, cores, threads, generation, cache, price, int_gfx;
                    generation = "6th";
                    if (specsheet==1)
                        {
                            name = "Pentium G4400";
                    ...
                    else if (specsheet==5)
                        {
                            ...
                            cores = 4;
                            threads =4;
                            clockspeed = "2.7 GHz (TurboBoost : 3.3GHz)";
                            cache = "6 MB";
                            power = "64W";
                            int_gfx = "HD Graphics 510";
                            price = "Rs. 14,000";
                    ...
                    else if (specsheet==6)
                        {
                            ...
                            cores = 4;
                            threads =4;
                            clockspeed = "3.2 GHz (TurboBoost : 3.6GHz)";
                            cache = "6 MB";
                            power = "65W";
                            int_gfx = "HD Graphics 530";
                            price = "Rs. 16,300";
                    ...
                    else if (specsheet==7)
                        {
                            ...
                            cores = 4;
                            threads =4;
                            clockspeed = "3.3 GHz (TurboBoost : 3.9GHz)";
                            cache = "6 MB";
                            power = "65W";
                            int_gfx = "HD Graphics 530";
                            price = "Rs. 17,300";
                    ...
                    else if (specsheet==8)
                        {
                            ...
                            cores = 4;
                            threads =8;
                            clockspeed = "4.0 GHz (TurboBoost : 4.2GHz)";
                            cache = "8 MB";
                            power = "91W";
                            int_gfx = "HD Graphics 530";
                            price = "Rs. 27,500";
                    ...
                    $("#valuec").append("<br/>").append(": ").append(generation);
                    $("#valuec").append("<br/>").append(": ").append(cores);
                    $("#valuec").append("<br/>").append(": ").append(threads);
                    $("#valuec").append("<br/>").append(": ").append(clockspeed);
                    $("#valuec").append("<br/>").append(": ").append(cache);
                    $("#valuec").append("<br/>").append(": ").append(power);
                    $("#valuec").append("<br/>").append(": ").append(int_gfx);
            ...
            $("#contentWindow4").mouseenter(function(){
                $("#nameTag4").html("Rs 14000");   
            });
            $("#contentWindow4").mouseout(function(){
                $("#nameTag4").html("6300");   
            });
            
            $("#contentWindow5").mouseenter(function(){
                $("#nameTag5").html("Rs 14000");   
            });
            $("#contentWindow5").mouseout(function(){
                $("#nameTag5").html("6400");   
            });
            
            $("#contentWindow6").mouseenter(function(){
                $("#nameTag6").html("Rs 16300");   
            });
            $("#contentWindow6").mouseout(function(){
                $("#nameTag6").html("6500");   
            });
            
            $("#contentWindow7").mouseenter(function(){
                $("#nameTag7").html("Rs 17300");   
            });
            $("#contentWindow7").mouseout(function(){
                $("#nameTag7").html("6600");   
            });
            
            $("#contentWindow8").mouseenter(function(){
                $("#nameTag8").html("Rs 27500");   
            });
            $("#contentWindow8").mouseout(function(){
                $("#nameTag8").html("6700K");   
            });
