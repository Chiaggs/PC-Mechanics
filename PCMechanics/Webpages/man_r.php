<html>
    ...
    <head>
        ...
        <style>
             ...
             #footer
            {
                width: 100%; height: 250px; position: absolute; margin-top: 500px; background: #001013;
            }
             @font-face
            {
...
/*      ----------------------------------------------------------------------------------------------------------           */
    ...
    <body id="spider">
        ...
        <div id="inpageTitle">
            <div id="titleImage"><img src="../Images/UI/menuItems/wramIcon.png" width="100%" height="100%"/></div>
            <div id="currentPageIndicator"><strong>RAM</strong></div>
        </div>
    ...
    <!--   -------------------------------------------------------------------------------     -->    
        ...
        <div id="pentiumTitle" class="subTag" style="margin-top:50px;">Corsair Vengeance</div>
        <div id="contentWindow1" class="contentWindow" onclick="specsheet_called(1);"><img src="../Images/Ram/ram_4_8.jpg" width="100%" height="100%"/></div>
        <div id="contentWindow2" class="contentWindow" onclick="specsheet_called(2);"><img src="../Images/Ram/ram_4_8.jpg" width="100%" height="100%"/></div>
        <div id="contentWindow3" class="contentWindow" onclick="specsheet_called(3);"><img src="../Images/Ram/ram_16.jpg" width="100%" height="100%"/></div>
        <div id="nameTag1" class="nameTag">4 GB</div>
        <div id="nameTag2" class="nameTag">8 GB</div>
        <div id="nameTag3" class="nameTag">16 GB</div>
                ...
                if(prev_button==buy_button)   //After Reclicking Selected Icon
                   {
                    ...
                    $("#proceed").click(function(){
                            ...
                            window.location="man_s.php?pro="+buy_button;
