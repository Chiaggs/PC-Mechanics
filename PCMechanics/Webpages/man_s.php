...
/*      ----------------------------------------------------------------------------------------------------------           */
    ...
    <body id="spider">
        ...
        <div id="inpageTitle">
            <div id="titleImage"><img src="../Images/UI/menuItems/wsmpsIcon.png" width="100%" height="80%" style="margin-top : 4px;"/></div>
            <div id="currentPageIndicator"><strong>SMPS</strong></div>
        </div>
    ...
    <!--   -------------------------------------------------------------------------------     -->    
        ...
        <div id="pentiumTitle" class="subTag" style="margin-top:50px;">VS Series</div>
        <div id="contentWindow1" class="contentWindow" onclick="specsheet_called(1);"><img src="../Images/Smps/vs450.jpg" width="100%" height="100%"/></div>
        <div id="contentWindow2" class="contentWindow" onclick="specsheet_called(2);"><img src="../Images/Smps/vs550.jpg" width="100%" height="100%"/></div>
        <div id="contentWindow3" class="contentWindow" onclick="specsheet_called(3);"><img src="../Images/Smps/vs650.jpg" width="100%" height="100%"/></div>
        <div id="nameTag1" class="nameTag">VS 450</div>
        <div id="nameTag2" class="nameTag">VS 550</div>
        <div id="nameTag3" class="nameTag">VS 650</div>
        ...
        <div id="i3Title" class="subTag">CS Series</div>
        
        
        <div id="contentWindow4" class="contentWindow" onclick="specsheet_called(4);"><img src="../Images/Smps/cs750m.jpg" width="100%" height="100%"/></div>
        
        <div id="nameTag4" class="nameTag">CS 750M</div>
                ...
                if(prev_button==buy_button)   //After Reclicking Selected Icon
                   {
                    ...
                    $("#proceed").click(function(){
                            ...
                            window.location="man_d.php?pro="+buy_button;
